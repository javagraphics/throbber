 ...
 * <P>The default period for this animation is 500, but you can modify
...
public class AquaThrobberUI extends ThrobberUI {
	 ...
	 * <p>It is strongly recommended that you use quality rendering hints
	 * (include stroke control) to achieve an aesthetic look.
	 * 
	...
	@Override
	public void paintForeground(Graphics2D g, JComponent jc,Dimension size,Float fixedFraction) {
		float f;
